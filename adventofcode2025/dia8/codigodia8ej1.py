...
while keepgoing:
    ...
    if len(connectedJunctionBoxes) == 1 and len(connectedJunctionBoxes[0]) == 1000:
        print([connectedBoxes[0],connectedBoxes[1]])
        keepgoing = False

    print(len(connectedJunctionBoxes[0]))
    print("va")
    print(len(connectedJunctionBoxes))
